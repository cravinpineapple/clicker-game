...
public class MarketClickListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (button == panel.getClickBSButton() && panel.getClicker().getWallet() >= 500) {
		...
		if (button == panel.getClickMSButton() && panel.getClicker().getWallet() >= 5000) {
		...
		if (button == panel.getClickPHDButton() && panel.getClicker().getWallet() >= 10000) {
